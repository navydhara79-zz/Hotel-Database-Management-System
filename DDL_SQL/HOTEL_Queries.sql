...
-- How many available rooms are in a particular hotel for a given date?
	SELECT h.hotel_room_capacity AS 'Total Rooms', 
    SUM(total_rooms_booked) AS 'Total Rooms Booked' , 
    h.hotel_room_capacity - SUM(b.total_rooms_booked) 	AS 'Available Rooms'	-- get available rooms
