...
CREATE TABLE IF NOT EXISTS hotel_db.Bookings_Audit(
...
(NULL,NEW.booking_id, NEW.booking_date, NEW.duration_of_stay, NEW.`check_in_date`, NEW.`check_out_date`, NEW.`booking_payment_type`, NEW.`total_rooms_booked`, NEW.`hotel_hotel_id`, NEW.`guests_guest_id`, NEW.`employees_emp_id`, NEW.`total_amount`,"INSERTED", NOW());
END//
...
-- values('16','2018-08-14 00:00:00','10','2018-08-17 12:00:00','2018-08-20 23:00:00','cash','1','1','5','3','500');



select *  from hotel_db.bookings;

SELECT 
    *
FROM
    hotel_db.Bookings_Audit;